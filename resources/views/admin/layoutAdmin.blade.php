...
<body class="bg-gray-100 font-sans">
    <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 shadow-[0_4px_30px_rgba(0,0,0,0.2)]">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="#" class="flex ms-2 md:me-24">
                        <img src="{{ asset('images/logo.jpeg') }}" class="h-8 me-3" alt="FlowBite Logo" />
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">COZY QUARTER - ADMIN</span>
                    </a>
                </div>
            ...
            <ul class="space-y-2 font-medium">
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{route('shelf.index')}}"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">Shelf</a>
                        </li>
                        <li>
                            <a href="{{route('category.index')}}"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">Category</a>
                        </li>
                        <li>
                            <a href="{{route('book.index')}}"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">Book</a>
                        </li>

                        <li>
                            <a href="{{route('borrowing.index')}}"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">Borrowing</a>
                        </li>

                        <li>
                            <a href="{{route('cwspace.index')}}"
                        ...
                        <li>
                            <a href="{{route('reservation.index')}}"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">Reservation</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul id="dropdown-reports" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">Beverage Report</a>
                        </li>
                    </ul>
                </li>
