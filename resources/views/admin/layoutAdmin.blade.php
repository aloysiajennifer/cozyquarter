...
<body>
    ...
    <nav id="top-navbar" class="fixed top-0 right-0 left-0 z-50 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-50 h-screen w-64 transition-transform -translate-x-full sm:translate-x-0 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700" aria-label="Sidebar">
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium pt-4">
                <li>
                    <a href="#" class="flex items-center p-2 rounded-lg group sidebar-link text-gray-900 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
