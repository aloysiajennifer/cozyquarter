            ...
            <table class="w-full text-sm text-left text-gray-500 bg-white border border-gray-200 rounded-lg shadow-md">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 sticky top-0 z-10">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-primary">Availability</th>
                ...
                <tbody>
                    @foreach($beverages as $beverage)
                        <tr class="bg-white border-b hover:bg-gray-100">
                            ...
                            <td class="px-6 py-4">
                                <img src="{{ asset($beverage->image) }}" alt="Image" class="w-16 h-20 object-cover rounded">
                            </td>
                            <td class="px-6 py-4 font-medium text-[var(--primary)] whitespace-nowrap">
                                {{ $beverage->name }}
                            </td>
                            <td class="px-6 py-4 text-[var(--primary)]">Rp {{ number_format($beverage->price, 0, ',', '.') }}</td>
                            <td class="px-6 py-4 text-[var(--primary)]">
                                @if($beverage->availability)
...
>>>>>>> 52c76d88329c1d2515840df4107164a6e26264e3
                                    ...
                                    <form action="{{ route('beverage.delete', ['id' => encrypt($beverage->id)]) }}" method="POST"
