...
@section('content')
<div class="pt-16 p-4 min-h-screen bg-white dark:bg-gray-800">
    <div class="container mx-auto p-4">
        ...
        <h1 class="text-center text-3xl font-semibold text-[var(--primary)] mb-6 dark:text-white">Add Beverage Form</h1>
