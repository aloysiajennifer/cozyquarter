    ...
    <form action="{{ route('shelf.insert') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-6 flex">
                ...
                <input type="text" id="code_shelf" name="code_shelf" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[var(--accent-green)] focus:border-[var(--accent-green)] block w-2/3 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Enter shelf code" required />
            </div>
            </div>
