...
@section('content')
    ...
    <div class="pt-16">
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                deleteButtons.forEach(button => {
                    button.addEventListener('click', function () {
                        ...
                        const shelfCode = this.getAttribute('data-title');

                        Swal.fire({
                            title: 'Are you sure?',
                            text: `You are about to delete "${shelfCode}"`,
                            icon: 'warning',
        ...
        <div class="w-full p-4 min-h-screen">
            ...
            <h1 class="text-center text-3xl font-semibold text-[var(--primary)] mt-2 mb-6 dark:text-white">Shelf List</h1>

            <form action="{{ route('shelf.index') }}" method="GET" class="max-w-md mx-auto mb-4">
                ...
                <div class="relative">
                    ...
                    <input type="search" name="search" id="search"
                        ...
                        placeholder="Search by code..." value="{{ request('search') }}">
                    <button type="submit"
                ...
                <table class="w-full text-sm text-left text-gray-500 bg-white border border-gray-200 rounded-lg shadow-md">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 sticky top-0 z-10">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-primary">Shelf Code</th>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-100">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex space-x-2 justify-end">
                                        ...
                                        <form action="{{ route('shelf.delete', ['id' => encrypt($shelf->id)]) }}"
                                            method="POST">
                                            @csrf
                                            <button type="button"
