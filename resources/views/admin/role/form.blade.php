...
@section('content')
    <div class="mt-16 p-4 min-h-screen">
        <div class="container mx-auto p-4">
            ...
            <h1 class="text-center text-3xl font-semibold text-[var(--primary)] mb-6 dark:text-white">Add Role Form</h1>
            <form action="{{ route('role.insert') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="max-w-3xl mx-auto">
                    <div>
                        <div class="mb-6 flex">
                            <label for="type"
                                class="w-1/3 block mb-2 text-sm font-medium text-[var(--primary)] dark:text-white">Type</label>
