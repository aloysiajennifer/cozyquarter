...
@section('content')
    <div class="pt-16">
        ...
        <div class="w-full p-4 min-h-screen">
            ...
            <h1 class="text-center text-3xl font-semibold text-[var(--primary)] mt-2 mb-6 dark:text-white">Role List</h1>

            <form action="{{ route('role.index') }}" method="GET" class="max-w-md mx-auto mb-4">
                ...
                <table class="w-full text-sm text-left text-gray-500 bg-white border border-gray-200 rounded-lg shadow-md">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 sticky top-0 z-10">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-primary">Type</th>
                    ...
                    <tbody>
                        @foreach($roles as $role)
                            <tr class="bg-white border-b hover:bg-gray-100">
                                ...
                                <td class="px-6 py-4 font-medium text-[var(--primary)]">{{ $role->type }}</td>
                                <td class="px-6 py-4">
                                    <div class="flex space-x-2 justify-end">
                                        <a href="{{ url('admin/role/detail/' . encrypt($role->id)) }}">
                                            <button type="button"
                                        ...
                                        <form action="{{ route('role.delete', ['id' => encrypt($role->id)]) }}"
                                            method="POST">
                                            @csrf
                                            <button type="button"
