...
<div class="py-20 flex items-center justify-center">
    <div class="w-full max-w-6xl px-5 text-center">
        ...
        <p class="mt-6 text-sm text-gray-700 text-center">
            <strong>Note:</strong> In the event of a <strong>no-show</strong>, a <span class="text-red-600 font-bold">blacklist</span> will be issued, preventing you from making future reservations. Please consider <a href="{{ route('user.reservations.index') }}" >canceling your reservation</a> in advance.
        </p>
    </div>
</div>
...
<div id="successModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full text-left">
        ...
        <p class="text-sm text-gray-700 text-center">
            Please check "Your Reservation" for further details. Thank you!
        </p>
